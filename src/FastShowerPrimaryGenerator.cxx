...
/// \file FastShowerPrimaryGenerator.cxx
/// \brief Implementation of the FastShowerPrimaryGenerator class
///
...
/// \cond CLASSIMP
ClassImp(FastShowerPrimaryGenerator)
/// \endcond

//_____________________________________________________________________________
FastShowerPrimaryGenerator::FastShowerPrimaryGenerator(TVirtualMCStack* stack)
  : TObject(),
    fStack(stack),
    fIsRandom(false),
...
//_____________________________________________________________________________
FastShowerPrimaryGenerator::FastShowerPrimaryGenerator(const FastShowerPrimaryGenerator& origin,
...
//_____________________________________________________________________________
FastShowerPrimaryGenerator::FastShowerPrimaryGenerator()
  : TObject(),
    fStack(0),
    fIsRandom(false),
    fPrimaryType(kDefault),
...
//_____________________________________________________________________________
void FastShowerPrimaryGenerator::GeneratePrimary1(const TVector3& origin)
{
...
//_____________________________________________________________________________
void FastShowerPrimaryGenerator::GeneratePrimary2(const TVector3& origin)
{
...
//_____________________________________________________________________________
void FastShowerPrimaryGenerator::GeneratePrimary3(const TVector3& origin)
{
...
//_____________________________________________________________________________
void FastShowerPrimaryGenerator::GeneratePrimary4(const TVector3& origin)
{
/// Add light anti-ions:
...
//_____________________________________________________________________________
void FastShowerPrimaryGenerator::GeneratePrimary5(const TVector3& origin)
{
...
//_____________________________________________________________________________
void FastShowerPrimaryGenerator::GeneratePrimaries(const TVector3& origin)
{
